        ...
        <div class="footer__grid">
            <div>
                ...
                <div class="footer__social">
                    ...
                    <a href="#" class="footer__social-link" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
                </div>
            </div>
            <div>
                ...
                <ul class="footer__links">
                    ...
                    <li><a href="#pricing" class="footer__link">Tarieven</a></li>
            ...
            <div>
                ...
                <ul class="footer__links">
                    ...
                    <li class="footer__contact-item">
                        <i class="fas fa-building footer__contact-icon"></i>
                        <span>KvK: 96512229<br>BTW-nr: NL004887238B66</span>
                    </li>
                </ul>
            </div>
        </div>
...
<!-- Back to top -->
<div class="back-to-top" id="back-to-top" aria-label="Terug naar boven">
